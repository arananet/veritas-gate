...
- Current model ids in the shipped examples and `.env.example`: `claude-sonnet-5`,
  `gpt-5.4-luna`, `gemini-3.57-pro`. The example-paper test no longer names the default
